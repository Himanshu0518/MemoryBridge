...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        ...
        <FormField label="Password" error={errors.password?.message} htmlFor="password" required>
          <Input
            ...
            aria-invalid={!!errors.password} leftIcon={<Lock />}
            rightElement={
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/auth/forgot-password" className="text-sm font-medium underline-offset-4 hover:underline">
            Forgot password?
          </Link>
        </div>

        <Button type="submit" size="lg" disabled={isLoading} className={cn("w-full", isLoading && "cursor-not-allowed")}>
      ...
      <Button type="button" variant="outline" size="lg" className="w-full gap-2" onClick={() => {}}>
